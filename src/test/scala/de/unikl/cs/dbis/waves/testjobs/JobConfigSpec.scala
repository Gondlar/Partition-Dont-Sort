...
class JobConfigSpec extends WavesSpec {
  ...
  "A JobConfig" can {
    ...
    behave like valueWithDefault('parquetPath, "/asd/f", "file://foo/out/spill/", Seq(("filesystem", "file://foo")))
    behave like valueWithDefault('wavesPath, "/asd/f", "file://foo/out/", Seq(("filesystem", "file://foo")))
